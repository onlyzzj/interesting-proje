...
struct _acc  acc;	
struct _gyro gyro;
s16 acc_x_offset=-145,acc_y_offset=0,acc_z_offset=372,gyro_x_offset=60,gyro_y_offset=-27,gyro_z_offset=15;
...
{
//	MPU6050_Offset();
	acc.x=((((int16_t)MPU6050_Buffer[0])<<8)|MPU6050_Buffer[1])+acc_x_offset;//-offset_acc.x;	//减去零偏
	acc.y=((((int16_t)MPU6050_Buffer[2])<<8)|MPU6050_Buffer[3])+acc_y_offset;//-offset_acc.y;
	acc.z=((((int16_t)MPU6050_Buffer[4])<<8)|MPU6050_Buffer[5])+acc_z_offset;//-offset_acc.z;

	gyro.x=((((int16_t)MPU6050_Buffer[8])<<8)|MPU6050_Buffer[9])+gyro_x_offset;//-offset_gyro.x;
	gyro.y=((((int16_t)MPU6050_Buffer[10])<<8)|MPU6050_Buffer[11])+gyro_y_offset;//-offset_gyro.y;
	gyro.z=((((int16_t)MPU6050_Buffer[12])<<8)|MPU6050_Buffer[13])+gyro_z_offset;//-offset_gyro.z;		
}
